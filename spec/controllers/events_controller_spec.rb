...
describe EventsController do
  ...
  def valid_attributes
    {:name=>"Деловая встреча",:start_at=>Time.now+3.months,:mode=>0,:mask=>0}
  end
  ...
  describe "GET index" do
    it "assigns all events as @events" do
      ...
      date=event.start_at
      get :index, {:day=>date.day,:month=>date.month,:year=>date.year}, valid_session
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created event" do
        post :create, {:event => valid_attributes}, valid_session
        response.should redirect_to(Event.unscoped.last)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested event" do
        ...
        Event.any_instance.should_receive(:update_attributes).with({'mode' => '1','mask'=>'3'})
        put :update, {:id => event.to_param, :event => {'mode' => '1','mask'=>'3'}}, valid_session
      end
